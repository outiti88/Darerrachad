            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    ...
                    <div class="card-body"> <small class="text-muted">Addresse email </small>
                        ...
                        <div class="map-box">
                            <iframe
                                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Marjane,%20Tanger%20PAC,%20Avenue%20des%20Forces%20Arm%C3%A9es%20Royales,%20Tanger%2090060+(Decathlon%20Tanger)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                width="100%" height="150" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div> <small class="text-muted p-t-30 db">Reseaux Sociaux</small>
                        <br />
                        <a href="https://www.facebook.com/DeliveryQuickoo" target="_blank"
                            class="btn btn-circle btn-secondary"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/DeliveryQuickoo" target="_blank"
                            class="btn btn-circle btn-secondary"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/quickoo/" target="_blank"
                            class="btn btn-circle btn-secondary"><i class="fab fa-linkedin"></i></a>
                    </div>
                </div>
            </div>
            <!-- Column -->
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST"
                            action="{{ route('profil.update', $user) }}">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="adresse" rows="5"
                                        class="form-control form-control-line">{{ $user->adresse }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12">Ville</label>
                                <div class="col-md-12">
                                    <input name="ville" type="text" value="{{ $user->ville }}"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
