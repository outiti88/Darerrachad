                    ...
                    <section class="services-offering">
                        <div class="container">
                            <div class="center-content">
                                <h2 class="section-title">Services, Nous offrons</h2>
                                <span class="underline center"></span>
                                <p class="lead">Heureux de vous servir!</p>
                                ...
                                <ul>
                                    <li class="col-sm-3">
                                        <div class="fact-item icon-ebooks">
                                            <div class="fact-icon">
                                                <img src="{{url('/vitrine/images/icon-ebooks.png')}}" alt="" />
                                            </div>
                                    ...
                                    <li class="col-sm-3">
                                        <div class="fact-item icon-eaudio">
                                            <div class="fact-icon">
                                                <img src="{{url('/vitrine/images/icon-eaudio.png')}}" alt="" />
                                            </div>
                                    ...
                                    <li class="col-sm-3">
                                        <div class="fact-item icon-magazine">
                                            <div class="fact-icon">
                                                <img src="{{url('/vitrine/images/icon-magazine.png')}}" alt="" />
                                            </div>
                                    ...
                                    <li class="col-sm-3">
                                        <div class="fact-item icon-videos">
                                            <div class="fact-icon">
                                                <img src="{{url('/vitrine/images/icon-videos.png')}}" alt="" />
                                            </div>
                            ...
                            <div class="owl-carousel">
                                <div class="single-testimonial-box">
                                    <div class="top-portion">
                                        <img src="{{url('/vitrine/images/testimonial-image-01.jpg')}}" alt="Testimonial Image" />
                                ...
                                <div class="single-testimonial-box">
                                    <div class="top-portion">
                                        <img src="{{url('/vitrine/images/testimonial-image-02.jpg')}}" alt="Testimonial Image" />
                                        <div class="user-comment">
                                            <div class="arrow-left"></div>
                                            <blockquote cite="#">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
